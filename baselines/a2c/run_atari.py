...
from baselines.a2c import auto_a2c, a2c
from baselines.common.vec_env.subproc_vec_env import SubprocVecEnv
from baselines.common.atari_wrappers import make_atari, wrap_deepmind
from baselines.a2c.policies import CnnPolicy, LstmPolicy, LnLstmPolicy, AutoencoderPolicy
...
def main():
    ...
    if args.show:
        ...
        logger.configure(dir="/home/noju/Documents/baselines/log/" + args.policy + "/")
        train(args.env, num_timesteps=args.num_timesteps, seed=args.seed, policy=args.policy, lrschedule=args.lrschedule, num_cpu=16)
